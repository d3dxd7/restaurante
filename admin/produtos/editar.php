...
<!doctype html>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= $back_url . '/produtos'; ?>">Produtos</a></li>
    ...
    <div class="container">
        ...
        <form method="post" action="<?= $back_url . '/produtos/update.php?id=' . $_GET['id'] ?>" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="preco" class="form-control real" value="<?= number_format($produto['preco'],2,',','.') ?>">
            </div>
            <br>
            <div>
                <label>
            ...
            <div>
                ...
                <br>
                <img src="<?= $front_url . '/img/uploads/produtos/' . $produto['imagem'] ?>" style="max-width: 150px;">
